...
SLEEP_TIME_TO_GET_FLIGHT_IN_SECS = config['DEFAULT']['SLEEP_TIME_TO_GET_FLIGHT_IN_SECS'] # SECONDS
SLEEP_TIME_TO_SEARCH_NEW_FLIGHTS_IN_SECS = config['DEFAULT']['SLEEP_TIME_TO_SEARCH_NEW_FLIGHTS_IN_SECS'] # SECONDS
ITERATIONS_LIMIT_TO_SEARCH_FLIGHTS = config['DEFAULT']['ITERATIONS_LIMIT_TO_SEARCH_FLIGHTS'] # INTEGER
FLIGHT_PATH_PARTITION_INTERVAL_IN_DEGREES = config['DEFAULT']['FLIGHT_PATH_PARTITION_INTERVAL_IN_DEGREES'] # DEGRES 
