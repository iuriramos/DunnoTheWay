...
SLEEP_TIME_TO_GET_FLIGHT_IN_SECS = config['DEFAULT']['SLEEP_TIME_TO_GET_FLIGHT_IN_SECS'] 
SLEEP_TIME_TO_SEARCH_NEW_FLIGHTS_IN_SECS = config['DEFAULT']['SLEEP_TIME_TO_SEARCH_NEW_FLIGHTS_IN_SECS']
ITERATIONS_LIMIT_TO_SEARCH_FLIGHTS = config['DEFAULT']['ITERATIONS_LIMIT_TO_SEARCH_FLIGHTS'] 
FLIGHT_PATH_PARTITION_INTERVAL_IN_DEGREES = config['DEFAULT']['FLIGHT_PATH_PARTITION_INTERVAL_IN_DEGREES'] 
CRUISING_VERTICAL_RATE_IN_MS = config['DEFAULT']['CRUISING_VERTICAL_RATE_IN_MS'] # METERS / SECOND
MIN_NUMBER_TO_SAVE_FLIGHT_LOCATIONS = config['DEFAULT']['MIN_NUMBER_TO_SAVE_FLIGHT_LOCATIONS']
SLEEP_TIME_TO_RETRY_NEW_CONNECTION_IN_SECS = config['DEFAULT']['SLEEP_TIME_TO_RETRY_NEW_CONNECTION_IN_SECS'] 
ITERATIONS_LIMIT_TO_RETRY_NEW_CONNECTION = config['DEFAULT']['ITERATIONS_LIMIT_TO_RETRY_NEW_CONNECTION'] 
