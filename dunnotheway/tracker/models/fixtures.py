...
def setup_environment():
    ...
    # create airports
    BSB_airport = Airport('SBBR', 'Brasília International Airport', -15.869, -47.918, 1060,  'BSB', 'Brazil')
    GRU_airport = Airport('SBGR', 'São Paulo-Guarulhos International Airport', -23.426, -46.468, 750, 'GRU', 'Brazil')
    SDU_airport = Airport('SBRJ', 'Santos Dumont Airport', -22.906,  -43.158, 3, 'SDU', 'Brazil')
    CGH_airport = Airport('SBSP', 'São Paulo-Congonhas Airport', -23.623, -46.652, 802, 'CGH', 'Brazil')

    # create flight plans (GRU >> BSB)
    azul_2925 = FlightPlan('AZU2925', GRU_airport, BSB_airport)
    ...
    azul_2539 = FlightPlan('AZU2539', BSB_airport, GRU_airport)
    azul_2926 = FlightPlan('AZU2926', BSB_airport, GRU_airport)
    azul_4015 = FlightPlan('AZU4015', BSB_airport, GRU_airport)
    azul_4277 = FlightPlan('AZU4277', BSB_airport, GRU_airport)
    azul_4493 = FlightPlan('AZU4493', BSB_airport, GRU_airport)
